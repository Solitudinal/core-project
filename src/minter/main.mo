...
actor class DRC721(_name : Text, _symbol : Text) {
    ...
    private stable var tokenURIEntries : [(T.TokenId, Text)] = [(1, "https://gistcdn.githack.com/Solitudinal/4dba1a4e03a8d68be2ae358b6ae79b22/raw/6c43afd8cff0e20697421d7dcf74fab7db7074ce/base.svg"), (2, "https://gistcdn.githack.com/Solitudinal/a2c3870a608daf63d89798cbf37903a8/raw/eec6ed09c72227e50a21c2db70fcaeb16119f258/BIRTHDAY.svg"), (3, "https://gistcdn.githack.com/Solitudinal/a2c3870a608daf63d89798cbf37903a8/raw/eec6ed09c72227e50a21c2db70fcaeb16119f258/BLACK.svg"), (4, "https://gistcdn.githack.com/Solitudinal/a2c3870a608daf63d89798cbf37903a8/raw/eec6ed09c72227e50a21c2db70fcaeb16119f258/BLUE.svg"), (5, "https://gistcdn.githack.com/Solitudinal/a2c3870a608daf63d89798cbf37903a8/raw/eec6ed09c72227e50a21c2db70fcaeb16119f258/BLUE_RED.svg"), (6, "https://gistcdn.githack.com/Solitudinal/a2c3870a608daf63d89798cbf37903a8/raw/eec6ed09c72227e50a21c2db70fcaeb16119f258/CROWN.svg"), (7, "https://gistcdn.githack.com/Solitudinal/a2c3870a608daf63d89798cbf37903a8/raw/eec6ed09c72227e50a21c2db70fcaeb16119f258/GREEN.svg"), (8, "https://gistcdn.githack.com/Solitudinal/a2c3870a608daf63d89798cbf37903a8/raw/eec6ed09c72227e50a21c2db70fcaeb16119f258/HAT.svg"), (9, "https://gistcdn.githack.com/Solitudinal/a2c3870a608daf63d89798cbf37903a8/raw/eec6ed09c72227e50a21c2db70fcaeb16119f258/RED.svg"), (10, "https://gistcdn.githack.com/Solitudinal/a2c3870a608daf63d89798cbf37903a8/raw/eec6ed09c72227e50a21c2db70fcaeb16119f258/WITH_CHAIN.svg"), (11, "https://gistcdn.githack.com/Solitudinal/a2c3870a608daf63d89798cbf37903a8/raw/eec6ed09c72227e50a21c2db70fcaeb16119f258/WITH_RING.svg")];
    ...
    public func showURI() : async [(T.TokenId, Text)] {
        return tokenURIEntries;
    };

    public shared query func getURI() : async Text {
        var currentURI = tokenURIs.get(tokenPk + 1);
        var unwrappedURI = Option.unwrap(currentURI);
        return unwrappedURI;
    };

    public shared({caller}) func getPrincipal() : async Text {
        var userId = Principal.toText(caller);
        return userId;
    };
